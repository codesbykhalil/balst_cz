  ...
  <div class="card8_1">
    <div style="width: 1280px">
      <div style="padding-right: 20px" class="icon_title_1">
        <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: white;margin-left: 40px;">6-爆破方案优化</h2>
      </div>
<!--      <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: black;margin-left: 40px;">5 爆破方案优化</h2>-->
      <!-- 超挖量评价表格 -->
      <div style="margin-left: 15px;display: flex;">
        <div class="left-column">
          ...
          <el-table
            :data="item.data"
            style="width: 350px; margin-left: 10px;font-size: 12px;border: 1px solid #5B9BD5"
            :row-style="rowStyle"
...
<!--      按钮-->
      <div  style="display: flex; align-items: center;">
        <span @click="analyze" class="draw_button" style="margin:30px 0 0 560px">智能分析与优化</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    updateScore(item, dataIndex) {
      ...
      // 更新 transformEvaluationItems 中的 selectedValue
      this.transformEvaluationItems[dataIndex].selectedValue = score;
    },
