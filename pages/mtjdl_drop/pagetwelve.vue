  ...
  <div class="card8_1">
    <div>
      <div style="padding-right: 20px" class="icon_title">
        <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: white;margin-left: 40px;">3-装药量计算</h2>
      </div>

      <div  style="display: flex; align-items: center;justify-content: center">
        <span class="draw_button" style="margin: 30px 0 0 60px;" @click="calculate()">炮孔统计制表</span>
      </div>
      ...
      <div>
        <h3  style="color: white;margin-left: 63px;
