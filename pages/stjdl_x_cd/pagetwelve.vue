  ...
  <div class="card8_1">
    <div>
      ...
      <div class="proovr-collect__tags" style="display: flex; align-items: center;">
        <span class="proovr-collect__tag" style="margin:30px 0 0 63px;width:200px" @click="calculate()">炮孔统计制表</span>
      </div>
      ...
      <div>
        <h3   style=" margin-left: 63px;
                ...
                width: 400px;margin-top: 15px"><strong>设计总药量为:</strong>
        ...
        <h3   style=" margin-left: 55px;margin-top: 10px;
                font-size: 18px !important;
                width: 400px;margin-top: 12px">&ensp;<strong>设计单耗值为:</strong>
          <el-input style="width:1160px;margin-left: 10px;margin-top: 10px" v-model="unitCon" :readonly="true"></el-input>
        </h3>
      </div>
    </div>
  </div>
