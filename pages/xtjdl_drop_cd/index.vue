...
<el-container class="operation-wrapper_1" >
  ...
  <div class="top-box">
      ...
      <el-menu-item index="1" style="font-size: 30px;color: #FFFFFF;">下台阶长短孔+楔形掏槽爆破方案设计</el-menu-item>
...
export default {
  ...
  mounted(){
    let projectId;
    cookie.get("upProjectId") ? projectId = cookie.get("upProjectId") : projectId = cookie.get("mdProjectId");//检测从哪里跳转的，优先考虑上台阶
    console.log(projectId);

    if (cookie.get("dwProjectId"))
    {

      console.log("dwProjectId: " + cookie.get("dwProjectId"));
    }
    else{
