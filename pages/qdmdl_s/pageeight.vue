      ...
      <div style="width:100%;">
        <div style="margin-top: -50px;margin-left: 65px">
          ...
          <div class="proovr1-collect__tags" style="display: flex; align-items: center;">
            <span @click="buildLine" class="proovr1-collect__tag" style="margin-left: 400px">确认并绘制开挖轮廓线</span>
            <span @click="clearLine" class="proovr1-collect__tag" style="margin-left: 60px">一键清除坐标</span>
          </div>
        </div>
      </div>
      <!-- 表格填入结束 -->
