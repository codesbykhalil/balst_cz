  ...
  <div class="card8">
   <div>
     <div style="padding-right: 20px" class="icon_title">
       <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: white;margin-left: 40px;">10-周边孔设置</h2>
     </div>
        <h3 class="font-type10" style="display:inline-block"><strong>装药直径：</strong>
          <br>
          <el-input style="width:1167px;margin-top: 10px" v-model="surDc"><template slot="suffix">mm</template></el-input>
        </h3>

     <br/>

        <h3 class="font-type10"  style="display:inline-block;"><strong>外插角：</strong>
          <br>
          <el-input style="width:1167px;margin-top: 10px" v-model="heterodyneAngle"></el-input>
        </h3>
     <br/>
     <div  style="display: flex; align-items: center;">
       <!--      <el-button style="margin:30px 0 0 200px" @click="calculate()" type="primary">试算孔距与光爆层厚度</el-button>-->
       <span @click="calculate" class="draw_button" style="margin:30px 0 0 560px">试算孔距与光爆层厚度</span>
     </div>
     <h3 class="font-type10" style="color:white;display:inline-block"><strong>试算孔距：</strong>
       <br>
       <el-input style="width:1167px;margin-top: 10px" v-model="surHoleSpacing"><template slot="suffix">m</template></el-input>
     </h3>
     <br/>
        <h3 class="font-type10" style="display:inline-block"><strong>光爆层厚度：</strong>
          <br>
          <el-input style="width:1167px;margin-top: 10px" v-model="blastThick"><template slot="suffix">m</template></el-input>
        </h3>

     <div  style="display: flex; align-items: center;">
       <!--      <el-button style="margin:30px 0 20px 200px" @click="calHoles()" type="primary">布孔并绘图</el-button>-->
       <span @click="calHoles" class="draw_button" style="margin:30px 0 30px 595px">布孔并绘图</span>
     </div>
