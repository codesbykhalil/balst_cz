<template>
  <div class="card8_1">
    <div>
      <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: black;margin-left: 40px;">6 周边孔布置</h2>
...
export default {
  ...
  methods:{
    ...
    calculate(){
      this.projectId = cookie.get("upProjectId");
      console.log("周边孔项目ID"+this.projectId);
      this.cal()
    },
    //计算周边孔的排距和光爆层厚度
    cal(){
