<template>
  <div class="card8_1">
    <div style="width: 1280px">
      <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: black;margin-left: 40px;">10 爆破方案优化</h2>
      <!-- 超挖量评价表格 -->
      <div>
        <div class="proovr-collect__tags" style="display: flex;">
          <span class="proovr-collect__tag" style="margin:30px 0 0 53px" @click="handleButtonClick">爆破现场数据接收</span>
        </div>
        <h3 style="margin-top:10px;text-align: center;font-size: 20px !important;"><strong>光爆效果评价</strong></h3>
      </div>
      <!-- 超挖量评价表格 -->
