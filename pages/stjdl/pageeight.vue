...
export default {
  ...
  data () {
    return {
      ...
      tableData: [
        {
          StringNum:1,x1: '6.55',y1: '-3.44',x2: '-6.55',y2: '-3.44',r: '0',serialLine:'',isBottom:1
        },{
          StringNum:2,x1: '-6.55',y1: '-3.44',x2: '-6.98',y2: '-1.64',r: '0',serialLine:'',isBottom:0
        },{
          StringNum:3,x1: '-6.98',y1: '-1.64',x2: '0',y2: '6.72',r: '7.17',serialLine:'',isBottom:0
        },{
          StringNum:4,x1: '0',y1: '6.72',x2: '6.98',y2: '-1.64',r: '7.17',serialLine:'',isBottom:0
        },{
          StringNum:5,x1: '6.98',y1: '-1.64',x2: '6.55',y2: '-3.44',r: '0',serialLine:'',isBottom:0
        },
  ...
  created(){
    if(cookie.get('upData')){
      ...
      this.stepLine1=upData.stepLine1;
      this.stepLine2=upData.stepLine2;
      this.buildLine();
    }
