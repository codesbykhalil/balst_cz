      ...
      <div style="margin: 20px 0 0 60px;width:100%;height:auto;">
        <div>
          <h3 class="font-type8" style="margin-left: 7px;color:white;"><strong>平均块度预测值为：</strong>
            <br>
            <el-input style="width:1167px;margin-top: 10px" v-model="avgFragment" readonly><template slot="suffix">m</template></el-input>
          </h3>
          <h3 class="font-type8" style="margin-left: 7px;color: white"><strong>最大块度预测值为：</strong>
            <br>
            <el-input style="width:1167px;margin-top: 10px;margin-bottom: 15px" v-model="maxFragment" readonly><template slot="suffix">m</template></el-input>
          </h3>
        </div>
