<template>
  <div>
      <div class="card5_1">
        <h2 class= title1-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: black;margin-left: 40px">5 隧道地应力(隧道埋深或地应力2选1填写)</h2><br><br>
        <!--        <div class="strength-div">-->
        <h3 style="
              font-size: 18px !important;
              width: 400px;margin-left: 68px;margin-top: -30px;padding-bottom: 20px;"><strong>隧道中心到地表距离：</strong>
        ...
        <h3   style=" margin-left: 68px;
                font-size: 18px !important;
                width: 400px;padding-bottom: 20px;"><strong>该处最大地应力值：</strong>
  ...
  methods: {
    loadData() {
      ...
      return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
          // 模拟加载成功
          this.strength1 = '1085.25';
          this.strength2 = 27.673875;
