...
<el-container class="operation-wrapper_1" >
  ...
  <div class="top-box">
      ...
      <el-menu-item index="1" style="font-size: 30px;color: #FFFFFF;">下台阶楔形掏槽爆破方案设计</el-menu-item>
...
<!--      <el-menu-item index="2" v-if="isUp" @click="doUpStap()">构建上台阶楔形掏槽爆破方案</el-menu-item>-->
      ...
      <el-menu-item index="5" @click="createNew">创建新项目</el-menu-item>
  	</el-menu>
...
.active_color{
  background-image: url('@/assets/img/menuBc.png');
  background-size: auto;
  height: 45px!important;
  line-height: 40px;
  background-repeat: no-repeat;
  color:#79FDFF!important;
}
.check_color{
  color: #3fa3ff;
}
