<template>
  <div class="card5_1">
    <div style="width: 1280px">
      <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: white;margin-left: 40px;">15 爆破方案优化</h2>
      <!-- 超挖量评价表格 -->
            ...
            <el-table
              ...
              <el-table-column :label="item.title" width="200px" align="center"  >
                <template slot-scope="scope">
                  <el-select v-model="scope.row.superExcavationValue" placeholder="" class="custom-select"
                             @change="updateScore(item, scope.$index)">
      ...
      <div style="margin: 20px 0 0 60px;width:100%;height:auto;">
        <div>
          <h3 class="font-type8" style="margin-left: 0px;color: white"><strong>原因分析</strong>
            <el-input :row="2" style="width:1167px;margin-top: 10px;height: 40px" v-model="reason">
              <template slot="suffix"></template>
            </el-input>
            <!--            type="textarea"-->
          </h3>
          <h3 class="font-type8" style="margin-left: 0px;color: white"><strong>优化建议</strong>
            <el-input :row="2" style="width:1167px;margin-top: 10px;margin-bottom: 15px" v-model="advice">
              <template slot="suffix"></template>
            </el-input>
          </h3>
        </div>
