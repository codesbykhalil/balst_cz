      ...
      <el-container class="operation-wrapper" >
        ...
        <el-header>
          <div class="top-box">
            ...
            <div class="header_title"><span style="color: #FFFFFF;font-size: 35px">分台阶+楔形掏槽</span></div>
          ...
          <el-main class="el-main-demo" style="height:100%;overflow-y: hidden">
            <el-row :gutter="10" class="umar-t10">
             ...
             overflow-y: scroll;overflow-x: hidden;padding-right: 20px;padding-left: 20px">
                  ...
                  <div class="screen" id="page_eighteen" style="margin-top: 30px;">
...
import pageeighteen from './/pageeighteen.vue'
export default {
  layout:'default',
  components:{
    pageeighteen,
  ...
  data(){
    return{
      ...
      activities: [
        ...
        {content: '设计模块切换',id: 'page_eighteen',icon: 'seventeen.png'},
      ],
      scrollHeight: [],
      token: '',
      active:'',
