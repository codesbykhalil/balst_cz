<template>
  <div class="card5_1">
    <div>
      <h2 class= title-before style="margin-top: 21px;padding-top:21px;font-size: 20px;!important;color: white;margin-left: 40px;">11 设计模块切换</h2>
      <br/>
      <div class="proovr1-collect__tags" style="display: flex; justify-content: space-between;padding-left: 300px;padding-right: 300px">
        <span @click="drop_mtj" class="proovr1-collect__tag" style="margin-left: 30px">跳转至中台阶</span>
        <span @click="drop_xtj" class="proovr1-collect__tag" style="margin-left: 400px">跳转至下台阶</span>
      </div>
    </div>
  </div>
</template>
