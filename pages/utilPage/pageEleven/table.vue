<template>
  <div>
    ...
    <div class="proovr-collect__tags" style="display: flex; align-items: center;">
      ...
      <!--    <span @click="buildLine" class="proovr-collect__tag" style="margin:20px 0 20px 520px">手动调整确认并绘图</span>-->
    </div>
  </div>
</template>
    ...
    auxHoleData:{
      handler(newV) {
        ...
        this.$nextTick(() => {
          ...
          divWarpChild.className = 'fix-warp2'
          ...
          this.tableWarp = document.querySelector(
            '.el-table .el-table__body-wrapper .fix-warp2'
          )
