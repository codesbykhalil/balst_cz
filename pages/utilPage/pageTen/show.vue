...
export default {
  ...
  methods: {
    init() {
      // 创建场景和相机
      //与show.js不同
      let container = document.getElementById("container_ten");
  ...
  watch: {
    ...
    vertices:{
      handler(newV) {
        ...
        //  console.log("getVertices "+JSON.stringify(this.getVertices));
    ...
    tube:{
      handler(newV) {
        this.getTube = newV;
        // console.log("tube"+JSON.stringify(this.getTube));
