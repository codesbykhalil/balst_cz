    ...
    <div>
        ...
        <div v-if="this.getHoleTableNum>0">
            <el-table
                ...
                size="large"
                style="width: 1160px;margin-top: 50px;margin-left: 24px;border: 1px solid #5B9BD5"
            ...
            >
              <div slot="empty" style="background-color: #01366a;width: 1200px;margin-left: -315px">暂无数据</div>
                ...
                <el-table-column label="外偏距离(m)" align="center">
                    <el-table-column
                        prop="distance"
                        width="130"
                        align="center">
        ...
        <div v-if="this.getHoleTableNum>3">
            ...
            >
              <div slot="empty" style="background-color: #01366a;width: 1200px;margin-left: -315px">暂无数据</div>
                <!-- 等级 -->
                <el-table-column label="四级" align="center">
                    <el-table-column
                        prop="holeNum"
                        width="119"
                        align="center">
        ...
        <div v-if="this.getHoleTableNum>4">
            ...
            >
              <div slot="empty" style="background-color: #01366a;width: 1200px;margin-left: -315px">暂无数据</div>
                <!-- 等级 -->
                <el-table-column label="五级" align="center">
                    <el-table-column
                        prop="holeNum"
                        width="119"
                        align="center">
...
<!--        <span @click="confirmAndDraw" class="proovr-collect__tag" style="margin:10px 0 5px 520px">手动调整确认并绘图</span>-->
      </div>
    </div>
</template>
    ...
    watch:{
      ...
      childData:{
        handler(newV) {
            ...
            this.holeTable4=[]
            this.holeTable5=[]
            if(this.fatherData!=null && this.fatherData!=[]){
                if(this.fatherData.data.cuttingHolesList==null){
                    this.fatherData.data.map((item) => {
